  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="h-[40vh] sm:h-[60vh] md:h-full w-[22.5vh] sm:w-[33.75vh] md:w-auto flex flex-col items-center justify-center order-1 md:order-2 bg-black/60 rounded-2xl md:rounded-[2rem] border border-white/10 overflow-hidden relative shadow-2xl shrink-0 aspect-[9/16] mx-auto md:mx-0"
      >
        <div className="absolute inset-0 w-full h-full bg-black">
          {bunnyPlayerSrc ? (
            <iframe
              key={`ugc-player-${activeIdx}`}
              src={bunnyPlayerSrc}
