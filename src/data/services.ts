...
export const FORMATS_DATA: Record<string, VideoData[]> = {
  UGC: [
    { title: "UGC Reel 1", videoPath: p("/UGC/BT 1.mp4") },
    { title: "UGC Reel 2", videoPath: p("/UGC/BT 2.mp4") },
    { title: "UGC Reel 3", videoPath: p("/UGC/BT 3.mp4") },
    { title: "UGC Reel 4", videoPath: p("/UGC/Blue tea 4.mp4") },
    { title: "UGC Reel 5", videoPath: p("/UGC/Seven Every day.mp4") },
    { title: "UGC Reel 6", videoPath: p("/UGC/Seven Ring Chor.mp4") },
    { title: "UGC Reel 7", videoPath: p("/UGC/Seven Ring.mp4") },
    { title: "UGC Reel 8", videoPath: p("/UGC/Seven UGC.mp4") },
    { title: "UGC Reel 9", videoPath: p("/UGC/Seven tap .mp4") },
    { title: "UGC Reel 10", videoPath: p("/UGC/Soul Flower 2.mp4") },
    { title: "UGC Reel 11", videoPath: p("/UGC/Soul Flower.mp4") },
    { title: "UGC Reel 12", videoPath: p("/UGC/0730(7).mp4") },
  ],
  DVC: [
  ...
  "Micro Drama": [
    { title: "Hula Hoop EP 1",   videoPath: p("/micro_drama/Hula Hoop 1  EP 1.mp4"), vimeoId: "1218023563" },
    { title: "Hula Hoop EP 2",   videoPath: p("/micro_drama/Hula Hoop 1  EP 2.mp4"), vimeoId: "1218023686" },
    { title: "Hula Hoop EP 3",   videoPath: p("/micro_drama/Hula Hoop 1  EP 3.mp4"), vimeoId: "1218023728" },
    { title: "Micro Drama 1",    videoPath: p("/micro_drama/0730(2).mp4"), vimeoId: "1218023562" },
    { title: "Micro Drama 2",    videoPath: p("/micro_drama/0730(3).mp4"), vimeoId: "1218023566" },
    { title: "Micro Drama 3",    videoPath: p("/micro_drama/0730(4).mp4"), vimeoId: "1218023565" },
    { title: "Hula Hoop 2 EP 1", videoPath: p("/micro_drama/Hula Hoop 2  EP 1.mp4"), vimeoId: "1218023736" },
    { title: "Micro Drama 4",    videoPath: p("/micro_drama/Hula Hoop 2  EP 2.mp4"), vimeoId: "1218023737" },
    { title: "Micro Drama 5",    videoPath: p("/micro_drama/Hula Hoop 2  EP 3.mp4"), vimeoId: "1218023779" },
  ],
  Photoshoot: [
