...
export const FORMATS_DATA: Record<string, VideoData[]> = {
  ...
  DVC: [
    ...
    { title: "DVC 1", videoPath: "/DVC/0730.webm" },
    { title: "DVC 2", videoPath: "/DVC/0730(1).webm" },
  ],
  "Micro Drama": [
    ...
    { title: "Micro Drama 1", videoPath: "/micro_drama/0730(2).webm" },
    { title: "Micro Drama 2", videoPath: "/micro_drama/0730(3).webm" },
    { title: "Hula Hoop 2 EP 1", videoPath: "/micro_drama/Hula Hoop 2 EP 1.webm" },
    { title: "Micro Drama 3", videoPath: "/micro_drama/microdrama.webm" },
    { title: "Micro Drama 4", videoPath: "/micro_drama/microdrama1.webm" },
    { title: "Micro Drama 5", videoPath: "/micro_drama/microdrama2.webm" },
  ],
  Photoshoot: [
